            ...
            <div className="center-column">
                ...
                <div className="form-card">
                    <div className="form-card-header">
                        ...
                        <div>
                            <h2 className="form-card-title">اطلاعات ادمین</h2>
                            <p className="form-card-subtitle">
                                اطلاعات کاربری و نقش ادمین جدید را وارد کنید.
                            </p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="form-body">
                        ...
                        <div className="form-group">
                            ...
                            <Select2
                                options={roleOptions}
                                value={selectedRoles} // ← آرایه‌ای از نقش‌های انتخاب شده
                                onChange={handleRolesChange} // ← آرایه دریافت می‌کند
                                placeholder="جستجو و انتخاب نقش‌ها..."
                                isMulti={true} // ← چند انتخابی فعال
                                isRtl={true}
                            />
                            {errors.roles && (
                                <div className="form-error">
                            ...
                            <p className="form-help-text">
                                می‌توانید چندین نقش را برای این ادمین انتخاب
                                کنید.
                                {data.roles.length > 0 && (
                                    <> ({data.roles.length} نقش انتخاب شده)</>
                                )}
                            </p>
                        </div>
